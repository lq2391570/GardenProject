//
//  BacketListBacketListBassClass.swift
//
...
public final class BacketListBacketListBassClass: NSCoding {
  ...
  public var no: Int?
  public var code: Int?
  public var list: [BacketListList]?
  public var size: Int?
  ...
  public required init(json: JSON) {
    ...
    if let items = json[SerializationKeys.list].array { list = items.map { BacketListList(json: $0) } }
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.list = aDecoder.decodeObject(forKey: SerializationKeys.list) as? [BacketListList]
