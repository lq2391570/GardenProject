//
//  CommentListCommentListBaseClass.swift
//
...
public final class CommentListCommentListBaseClass: NSCoding {
  ...
  public var no: Int?
  public var code: Int?
  public var list: [CommentListList]?
  public var size: Int?
  ...
  public required init(json: JSON) {
    ...
    if let items = json[SerializationKeys.list].array { list = items.map { CommentListList(json: $0) } }
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.list = aDecoder.decodeObject(forKey: SerializationKeys.list) as? [CommentListList]
