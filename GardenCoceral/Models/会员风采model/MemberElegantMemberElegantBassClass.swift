//
//  MemberElegantMemberElegantBassClass.swift
//
...
public final class MemberElegantMemberElegantBassClass: NSCoding {
  ...
  public var no: Int?
  public var code: Int?
  public var list: [MemberElegantList]?
  public var size: Int?
  ...
  public required init(json: JSON) {
    ...
    if let items = json[SerializationKeys.list].array { list = items.map { MemberElegantList(json: $0) } }
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.list = aDecoder.decodeObject(forKey: SerializationKeys.list) as? [MemberElegantList]
