//
//  HotBacketListHotBacketListBassClass.swift
//
...
public final class HotBacketListHotBacketListBassClass: NSCoding {
  ...
  private struct SerializationKeys {
    ...
    static let openMoney = "openMoney"
  }
  ...
  public var size: Int?
  public var list: [HotBacketListList]?
  public var num: Int?
  public var totalPage: Int?
  public var msg: String?
    public var money:Double?
    public var openMoney:Double?
  ...
  public required init(json: JSON) {
    ...
    if let items = json[SerializationKeys.list].array { list = items.map { HotBacketListList(json: $0) } }
    num = json[SerializationKeys.num].int
    money = json[SerializationKeys.money].double
    openMoney = json[SerializationKeys.openMoney].double
  ...
  public func dictionaryRepresentation() -> [String: Any] {
    ...
    if let value = openMoney { dictionary[SerializationKeys.openMoney] = value }
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.list = aDecoder.decodeObject(forKey: SerializationKeys.list) as? [HotBacketListList]
    ...
    self.money = aDecoder.decodeObject(forKey: SerializationKeys.money) as? Double
      self.openMoney = aDecoder.decodeObject(forKey: SerializationKeys.openMoney) as? Double
  ...
  public func encode(with aCoder: NSCoder) {
    ...
    aCoder.encode(openMoney, forKey: SerializationKeys.openMoney)
