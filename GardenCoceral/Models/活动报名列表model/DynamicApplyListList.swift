...
public final class DynamicApplyListList: NSCoding {
  ...
  // MARK: Properties
  public var member: DynamicApplyListMember?
  ...
  public required init(json: JSON) {
    member = DynamicApplyListMember(json: json[SerializationKeys.member])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.member = aDecoder.decodeObject(forKey: SerializationKeys.member) as? DynamicApplyListMember
