//
//  DynamicApplyListDynamicApplyList.swift
//
//  Created by shiliuhua on 18/04/2018
...
public final class DynamicApplyListDynamicApplyList: NSCoding {
  ...
  public var no: Int?
  public var code: Int?
  public var list: [DynamicApplyListList]?
  public var size: Int?
  ...
  public required init(json: JSON) {
    ...
    if let items = json[SerializationKeys.list].array { list = items.map { DynamicApplyListList(json: $0) } }
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.list = aDecoder.decodeObject(forKey: SerializationKeys.list) as? [DynamicApplyListList]
