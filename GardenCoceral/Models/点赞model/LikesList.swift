...
public final class LikesList: NSCoding {
  ...
  public required init(json: JSON) {
    ...
    member = LikesMember(json: json[SerializationKeys.member])
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.member = aDecoder.decodeObject(forKey: SerializationKeys.member) as? LikesMember
